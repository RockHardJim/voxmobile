...
public class Compatibility {
	...
	//	boolean supportFloating = getCpuAbi().equalsIgnoreCase("armeabi-v7a");
		...
		preferencesWrapper.setCodecPriority("SILK/8000/1", SipConfigManager.CODEC_NB, "255");
		preferencesWrapper.setCodecPriority("SILK/12000/1", SipConfigManager.CODEC_NB, "254");
		preferencesWrapper.setCodecPriority("SILK/16000/1", SipConfigManager.CODEC_NB, "253");
		preferencesWrapper.setCodecPriority("SILK/24000/1", SipConfigManager.CODEC_NB, "252");
		...
		preferencesWrapper.setCodecPriority("SILK/8000/1", SipConfigManager.CODEC_WB, "255");
		preferencesWrapper.setCodecPriority("SILK/12000/1", SipConfigManager.CODEC_WB, "254");
		preferencesWrapper.setCodecPriority("SILK/16000/1", SipConfigManager.CODEC_WB, "253");
		preferencesWrapper.setCodecPriority("SILK/24000/1", SipConfigManager.CODEC_WB, "252");
	...
	public static void updateVersion(PreferencesWrapper prefWrapper, int lastSeenVersion, int runningVersion) {
		if (lastSeenVersion < 14) {
			...
			if (TextUtils.isEmpty(prefWrapper.getStunServer())) {
				prefWrapper.setPreferenceStringValue(SipConfigManager.STUN_SERVER, ServiceHelper.getStunServer());
			}
		}
