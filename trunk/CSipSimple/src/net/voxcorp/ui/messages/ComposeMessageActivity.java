 ...
 */
package net.voxcorp.ui.messages;
...
import net.voxcorp.utils.SmileyParser;
	...
	class MessagesCursorAdapter extends ResourceCursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
	     ...
	     // Subject
	        ...
	        LinearLayout row = (LinearLayout)view.findViewById(R.id.mms_layout_view_parent);
	        ImageView spacerLeft = (ImageView)view.findViewById(R.id.mms_spacer_left);
	        ImageView spacerRight = (ImageView)view.findViewById(R.id.mms_spacer_right);
	        if (type == SipMessage.MESSAGE_TYPE_FAILED) {
	        	row.setBackgroundResource(R.drawable.voxmobile_chat_error);
	        	spacerLeft.setVisibility(View.VISIBLE);
	        	spacerRight.setVisibility(View.GONE);
	        } else if (type == SipMessage.MESSAGE_TYPE_INBOX) {
	        	row.setBackgroundResource(R.drawable.voxmobile_chat_receive);
	        	spacerLeft.setVisibility(View.GONE);
	        	spacerRight.setVisibility(View.VISIBLE);
	        } else {
	        	row.setBackgroundResource(R.drawable.voxmobile_chat_send);
	        	spacerLeft.setVisibility(View.VISIBLE);
	        	spacerRight.setVisibility(View.GONE);
	        }
		}
