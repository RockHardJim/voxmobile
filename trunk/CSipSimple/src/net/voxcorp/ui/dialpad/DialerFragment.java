...
package net.voxcorp.ui.dialpad;
...
import net.voxcorp.ui.SipHome;
import net.voxcorp.ui.SipHome.ViewPagerVisibilityListener;
import net.voxcorp.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import net.voxcorp.utils.CallHandlerPlugin;
import net.voxcorp.utils.CallHandlerPlugin.OnLoadListener;
...
import net.voxcorp.widgets.DialerCallBar.OnDialActionListener;
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), net.voxcorp.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
