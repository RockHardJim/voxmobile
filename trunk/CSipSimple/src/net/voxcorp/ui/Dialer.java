...
import net.voxcorp.animation.Flip3dAnimation;
...
import net.voxcorp.service.OutgoingCall;
import net.voxcorp.utils.CallHandler;
import net.voxcorp.utils.CallHandler.onLoadListener;
...
//	private GestureDetector gestureDetector;
	...
	private void placeVMCall() {
		...
		} else if (accountToUse == CallHandler.getAccountIdForCallHandler(this, "net.voxcorp/net.voxcorp.plugins.telephony.CallHandler")) {
			//Case gsm voice mail
