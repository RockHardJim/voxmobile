...
package net.voxcorp.pjsip.earlylock;
...
import net.voxcorp.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * net.voxcorp.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see net.voxcorp.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see net.voxcorp.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, net.voxcorp.api.SipProfile)
     */
    @Override
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "net.voxcorp.earlylock");
            wl.acquire();
        }
