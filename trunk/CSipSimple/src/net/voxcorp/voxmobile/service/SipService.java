...
import net.voxcorp.voxmobile.api.ISipConfiguration;
import net.voxcorp.voxmobile.api.ISipService;
import net.voxcorp.voxmobile.api.MediaState;
...
import net.voxcorp.voxmobile.db.DBProvider;
import net.voxcorp.voxmobile.models.Filter;
import net.voxcorp.voxmobile.pjsip.PjSipCalls;
import net.voxcorp.voxmobile.pjsip.PjSipService;
import net.voxcorp.voxmobile.pjsip.UAStateReceiver;
import net.voxcorp.voxmobile.service.receiver.DynamicReceiver4;
import net.voxcorp.voxmobile.service.receiver.DynamicReceiver5;
import net.voxcorp.voxmobile.ui.incall.InCallMediaControl;
...
import net.voxcorp.voxmobile.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "net.voxcorp.voxmobile.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "net.voxcorp.voxmobile.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "net.voxcorp.voxmobile.SipService");
