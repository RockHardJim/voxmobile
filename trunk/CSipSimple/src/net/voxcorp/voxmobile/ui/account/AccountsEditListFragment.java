...
import net.voxcorp.voxmobile.backup.SipProfileJson;
import net.voxcorp.voxmobile.ui.account.AccountsEditListAdapter.AccountRowTag;
import net.voxcorp.voxmobile.ui.account.AccountsEditListAdapter.OnCheckedRowListener;
import net.voxcorp.voxmobile.utils.PreferencesWrapper;
import net.voxcorp.voxmobile.vox.ui.AccountsListActivity;
import net.voxcorp.voxmobile.widgets.CSSListFragment;
import net.voxcorp.voxmobile.widgets.DragnDropListView;
import net.voxcorp.voxmobile.widgets.DragnDropListView.DropListener;
import net.voxcorp.voxmobile.wizards.BasePrefsWizard;
import net.voxcorp.voxmobile.wizards.WizardChooser;
import net.voxcorp.voxmobile.wizards.WizardUtils;
import net.voxcorp.voxmobile.wizards.WizardUtils.WizardInfo;
import net.voxcorp.voxmobile.wizards.impl.VoXMobile;
...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ OnCheckedRowListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVoXMobileVersionSupported = getActivity().getIntent().getBooleanExtra("version_supported", false);
	}
