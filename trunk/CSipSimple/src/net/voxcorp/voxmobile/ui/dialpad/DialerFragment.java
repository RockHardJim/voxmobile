...
package net.voxcorp.voxmobile.ui.dialpad;
...
import net.voxcorp.voxmobile.api.ISipService;
...
import net.voxcorp.voxmobile.ui.SipHome;
import net.voxcorp.voxmobile.ui.SipHome.ViewPagerVisibilityListener;
import net.voxcorp.voxmobile.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import net.voxcorp.voxmobile.utils.CallHandlerPlugin;
import net.voxcorp.voxmobile.utils.CallHandlerPlugin.OnLoadListener;
import net.voxcorp.voxmobile.utils.DialingFeedback;
...
import net.voxcorp.voxmobile.utils.contacts.ContactsSearchAdapter;
import net.voxcorp.voxmobile.vox.utils.VoXMobileUtils;
import net.voxcorp.voxmobile.widgets.AccountChooserButton;
import net.voxcorp.voxmobile.widgets.AccountChooserButton.OnAccountChangeListener;
import net.voxcorp.voxmobile.widgets.DialerCallBar;
import net.voxcorp.voxmobile.widgets.DialerCallBar.OnDialActionListener;
import net.voxcorp.voxmobile.widgets.Dialpad;
import net.voxcorp.voxmobile.widgets.Dialpad.OnDialKeyListener;
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        */
        ...
        /*
         * VoX Mobile :: Hook up the account chooser button to the VoX Mobile
         * SipHome helper so that we have a way to figure out which account is
         * currently in use
         */
        SipHome sipHome = (SipHome)getActivity();
        sipHome.getVoXMobileSipHomeHelper().setAccountChooserButton(accountChooserButton);
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), net.voxcorp.voxmobile.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
