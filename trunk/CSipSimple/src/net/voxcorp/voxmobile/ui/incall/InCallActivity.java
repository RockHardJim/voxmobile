...
package net.voxcorp.voxmobile.ui.incall;
...
import net.voxcorp.voxmobile.ui.PickupSipUri;
import net.voxcorp.voxmobile.ui.incall.CallProximityManager.ProximityDirector;
import net.voxcorp.voxmobile.ui.incall.DtmfDialogFragment.OnDtmfListener;
import net.voxcorp.voxmobile.ui.incall.locker.IOnLeftRightChoice;
import net.voxcorp.voxmobile.ui.incall.locker.InCallAnswerControls;
import net.voxcorp.voxmobile.ui.incall.locker.ScreenLocker;
import net.voxcorp.voxmobile.utils.CallsUtils;
...
import net.voxcorp.voxmobile.utils.keyguard.KeyguardWrapper;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger, 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "net.voxcorp.voxmobile.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "net.voxcorp.voxmobile.videoCall");
    ...
    public void onTrigger(int whichAction, final SipCallSession call) {
        ...
        try {
            switch (whichAction) {
                ...
                case VOX_MOBILE_PREVIEW: {
                	toggleVoXMobilePreview();
                	break;
                }
