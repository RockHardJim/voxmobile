...
package net.voxcorp.voxmobile.ui.incall.locker.multiwaveview;
...
//        return Gravity.getAbsoluteGravity(mGravity, layoutDirection);
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.voxmobile.widgets.IOnLeftRightChoice.IOnLeftRightProvider#setOnLeftRightListener(net.voxcorp.voxmobile.widgets.IOnLeftRightChoice)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.voxmobile.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#getLayoutingWidth()
     */
    @Override
