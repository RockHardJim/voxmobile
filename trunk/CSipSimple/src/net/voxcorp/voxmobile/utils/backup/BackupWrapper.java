...
package net.voxcorp.voxmobile.utils.backup;
	...
	public static BackupWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(8)) {
                instance = new net.voxcorp.voxmobile.utils.backup.BackupUtils8();
			}else {
                instance = new net.voxcorp.voxmobile.utils.backup.BackupUtils3();
			}
		    if(instance != null) {
