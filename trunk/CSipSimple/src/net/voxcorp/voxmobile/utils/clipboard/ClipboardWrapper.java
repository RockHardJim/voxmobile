 ...
 * 
 */
package net.voxcorp.voxmobile.utils.clipboard;
    ...
    public static ClipboardWrapper getInstance(Context context) {
        if(instance == null) {
            if(Compatibility.isCompatible(11)) {
                instance = new net.voxcorp.voxmobile.utils.clipboard.Clipboard11();
            }else {
                instance = new net.voxcorp.voxmobile.utils.clipboard.Clipboard1();
            }
            if(instance != null) {
