...
package net.voxcorp.voxmobile.utils.audio;
	...
	public static AudioFocusWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(8)) {
			    instance = new net.voxcorp.voxmobile.utils.audio.AudioFocus8();
			}else {
			    instance = new net.voxcorp.voxmobile.utils.audio.AudioFocus3();
			}
		}
