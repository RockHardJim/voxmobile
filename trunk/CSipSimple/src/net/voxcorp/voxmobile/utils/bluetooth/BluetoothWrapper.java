...
package net.voxcorp.voxmobile.utils.bluetooth;
	...
	public static BluetoothWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(14)) {
		        instance = new net.voxcorp.voxmobile.utils.bluetooth.BluetoothUtils14();
		    }else if(Compatibility.isCompatible(8)) {
                instance = new net.voxcorp.voxmobile.utils.bluetooth.BluetoothUtils8();
			}else {
                instance = new net.voxcorp.voxmobile.utils.bluetooth.BluetoothUtils3();
			}
		    if(instance != null) {
