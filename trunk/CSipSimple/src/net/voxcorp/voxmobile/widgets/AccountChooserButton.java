...
package net.voxcorp.voxmobile.widgets;
...
import net.voxcorp.voxmobile.utils.AccountListUtils;
import net.voxcorp.voxmobile.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), net.voxcorp.voxmobile.plugins.telephony.CallHandler.class);
