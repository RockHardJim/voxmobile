...
import net.voxcorp.voxmobile.api.SipUri.ParsedSipUriInfos;
import net.voxcorp.voxmobile.vox.utils.SimpleCrypto;
import net.voxcorp.voxmobile.wizards.impl.VoXMobile;
import net.voxcorp.voxmobile.wizards.impl.VoXMobile.VoXAccountType;
...
public class SipProfile implements Parcelable {
    ...
    private SipProfile(Parcel in) {
        ...
        datatype = in.readInt();
        data = getReadParcelableString(VoXMobile.getAccountType(wizard) == VoXAccountType.UNKNOWN ? in.readString() : SimpleCrypto.decrypt(in.readString()));
        use_srtp = in.readInt();
    ...
    private final void createFromContentValue(ContentValues args) {
         ...
         */
        if (VoXMobile.getAccountType(wizard) != VoXAccountType.UNKNOWN) {
        	data = SimpleCrypto.decrypt(data);
        }
    }
