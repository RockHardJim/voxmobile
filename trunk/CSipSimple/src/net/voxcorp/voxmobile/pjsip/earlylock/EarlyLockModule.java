...
package net.voxcorp.voxmobile.pjsip.earlylock;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * net.voxcorp.voxmobile.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see net.voxcorp.voxmobile.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see net.voxcorp.voxmobile.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, net.voxcorp.voxmobile.api.SipProfile)
     */
    @Override
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "net.voxcorp.voxmobile.earlylock");
            wl.acquire();
        }
