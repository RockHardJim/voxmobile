...
package net.voxcorp.voxmobile.wizards;
...
import net.voxcorp.voxmobile.wizards.impl.*;
...
public class WizardUtils {
	...
	private static void initWizards() {
		...
		if(CustomDistribution.distributionWantsOtherProviders()) {
		    /*
		     * VoX Mobile :: add VoX Mobile wizard 
		     */
			VoXMobileUtils.addWizards(WIZARDS_DICT);
            ...
            WIZARDS_DICT.put("ZENG_CN", new WizardInfo("ZENG_CN", "������������������", 
                    R.drawable.ic_wizard_zeng, 9, 
            ...
            WIZARDS_DICT.put("BGOPENNET", new WizardInfo("BGOPENNET", "BGOPEN.NET", 
                    ...
                    new Locale[]{ locale("bg_BG") }, false, false, 
                    BgOpen.class));
            WIZARDS_DICT.put("MEGAFONBG", new WizardInfo("MEGAFONBG", "������������������������������������������", 
