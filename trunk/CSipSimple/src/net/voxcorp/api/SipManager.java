...
public final class SipManager {
     ...
     */
    public static final String ACTION_SIP_FAVORITES = "net.voxcorp.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "net.voxcorp.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global csipsimple settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "net.voxcorp.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "net.voxcorp.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "net.voxcorp.service.CALL_RECORDED";
     ...
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "net.voxcorp.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "net.voxcorp.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "net.voxcorp.service.ACTION_DEFER_OUTGOING_UNREGISTER";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "net.voxcorp.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "net.voxcorp.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "net.voxcorp.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "net.voxcorp.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "net.voxcorp.phone.action.REWRITE_NUMBER"; 
    /**
     ...
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "net.voxcorp.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "net.voxcorp.plugins.action.REGISTER_VIDEO";
    /**
