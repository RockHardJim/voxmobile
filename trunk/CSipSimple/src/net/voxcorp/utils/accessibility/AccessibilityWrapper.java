...
package net.voxcorp.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new net.voxcorp.utils.accessibility.Accessibility4();
			}else {
			    instance = new net.voxcorp.utils.accessibility.Accessibility3();
			}
		}
