...
package net.voxcorp.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, net.voxcorp.widgets.contactbadge.QuickContactBadge topBadge) {
