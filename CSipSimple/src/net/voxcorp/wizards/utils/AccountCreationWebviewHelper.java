...
package net.voxcorp.wizards.utils;
    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new net.voxcorp.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new net.voxcorp.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
