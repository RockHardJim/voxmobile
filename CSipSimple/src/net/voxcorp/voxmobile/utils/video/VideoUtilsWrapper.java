...
package net.voxcorp.voxmobile.utils.video;
    ...
    public static VideoUtilsWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(5)) {
                instance = new net.voxcorp.voxmobile.utils.video.VideoUtils5();
            } else {
                instance = new net.voxcorp.voxmobile.utils.video.VideoUtils3();
            }
        }
