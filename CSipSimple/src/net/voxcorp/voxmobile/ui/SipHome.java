...
import net.voxcorp.voxmobile.ui.account.AccountsEditList;
import net.voxcorp.voxmobile.ui.calllog.CallLogListFragment;
import net.voxcorp.voxmobile.ui.dialpad.DialerFragment;
import net.voxcorp.voxmobile.ui.favorites.FavListFragment;
import net.voxcorp.voxmobile.ui.help.Help;
import net.voxcorp.voxmobile.ui.messages.ConversationsListFragment;
import net.voxcorp.voxmobile.ui.warnings.WarningFragment;
import net.voxcorp.voxmobile.ui.warnings.WarningUtils;
import net.voxcorp.voxmobile.ui.warnings.WarningUtils.OnWarningChanged;
import net.voxcorp.voxmobile.utils.Compatibility;
import net.voxcorp.voxmobile.utils.CustomDistribution;
import net.voxcorp.voxmobile.utils.Log;
import net.voxcorp.voxmobile.utils.NightlyUpdater;
import net.voxcorp.voxmobile.utils.NightlyUpdater.UpdaterPopupLauncher;
import net.voxcorp.voxmobile.utils.PreferencesProviderWrapper;
import net.voxcorp.voxmobile.utils.PreferencesWrapper;
import net.voxcorp.voxmobile.utils.Theme;
import net.voxcorp.voxmobile.utils.UriUtils;
import net.voxcorp.voxmobile.utils.backup.BackupWrapper;
import net.voxcorp.voxmobile.vox.utils.VoXMobileSettings;
import net.voxcorp.voxmobile.vox.utils.VoXMobileSipHomeHelper;
import net.voxcorp.voxmobile.vox.utils.VoXMobileSipHomeHelper.VoXMobileSipHomeHandler;
import net.voxcorp.voxmobile.wizards.BasePrefsWizard;
import net.voxcorp.voxmobile.wizards.WizardUtils.WizardInfo;
...
public class SipHome extends SherlockFragmentActivity implements OnWarningChanged {
    ...
    /**
     * VoX Mobile extensions
     */
    private ProgressDialog mVoXMobileProgress;
    private VoXMobileSipHomeHelper mVoXMobileSipHomeHelper = new VoXMobileSipHomeHelper(this);
    private VoXMobileSipHomeHandler mVoXMobileHandler = new VoXMobileSipHomeHandler(this);
    ...
    public VoXMobileSipHomeHelper getVoXMobileSipHomeHelper() {
    	return mVoXMobileSipHomeHelper;
    }
    public void doVoXMobileDisconnect(boolean quit) {
    	disconnect(quit);
    }
    public void doVoXMobileStartSipService() {
    	startSipService();
    }
        ...
        if (!hasTriedOnceActivateAcc) {
            ...
            if (accountCount == 0) {
                ...
                if (accountIntent != null) {
                	accountIntent.putExtra("version_supported", mVoXMobileSipHomeHelper.getVersionCheck().isSupported());
    ...
    protected void onResume() {
        ...
        if (!mVoXMobileSipHomeHelper.validVoXMobileBuild()) {
        	return;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(Menu.NONE, VoXMobileSipHomeHelper.TOP_UP_MENU, Menu.NONE, R.string.voxmobile_top_up).setIcon(R.drawable.ic_voxmobile_menu_topup);
        menu.add(Menu.NONE, VoXMobileSipHomeHelper.MANAGE_ACCOUNT_MENU, Menu.NONE, R.string.voxmobile_manage_account).setIcon(R.drawable.ic_voxmobile_menu_manage);
        ...
        menu.add(Menu.NONE, VoXMobileSipHomeHelper.RATES_MENU, Menu.NONE, R.string.voxmobile_rates).setIcon(R.drawable.ic_voxmobile_rates_menu);
        menu.add(Menu.NONE, VoXMobileSipHomeHelper.INVITE_MENU, Menu.NONE, R.string.voxmobile_invite).setIcon(android.R.drawable.ic_menu_send);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
    	mVoXMobileSipHomeHelper.prepareOptionsMenu(menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
        	case VoXMobileSipHomeHelper.TOP_UP_MENU:
        	case VoXMobileSipHomeHelper.MANAGE_ACCOUNT_MENU:
        	case VoXMobileSipHomeHelper.RATES_MENU:
        	case VoXMobileSipHomeHelper.INVITE_MENU:
            case ACCOUNTS_MENU:
            	if (mVoXMobileSipHomeHelper.getVersionCheck() == null) {
            		mVoXMobileSipHomeHelper.doVoXMobileVersionCheck(true);
            		return true;
            	}
            	mVoXMobileSipHomeHelper.handleMenuAction(item.getItemId());
                return true;
            case PARAMS_MENU:
