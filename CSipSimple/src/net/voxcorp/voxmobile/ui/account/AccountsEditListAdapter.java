...
public class AccountsEditListAdapter extends SimpleCursorAdapter implements OnClickListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        /*
         * VoX Mobile :: add extra account info
         */
        String acctType = VoXMobileUtils.getAccountType(context, account);
        ...
        if (account.active) {
            ...
            tagView.statusView.setText(acctType + mContext.getString(R.string.acct_inactive));
