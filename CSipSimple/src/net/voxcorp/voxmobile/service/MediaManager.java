...
import net.voxcorp.voxmobile.utils.Ringer;
import net.voxcorp.voxmobile.utils.accessibility.AccessibilityWrapper;
import net.voxcorp.voxmobile.utils.audio.AudioFocusWrapper;
import net.voxcorp.voxmobile.utils.bluetooth.BluetoothWrapper;
import net.voxcorp.voxmobile.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		*/
		...
		if(wifiLock == null) {
			wifiLock = wman.createWifiLock( 
							...
							"net.voxcorp.voxmobile.InCallLock");
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "net.voxcorp.voxmobile.onIncomingCall.SCREEN");
