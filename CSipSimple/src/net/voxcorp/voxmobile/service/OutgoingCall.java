...
import net.voxcorp.voxmobile.ui.outgoingcall.OutgoingCallChooser;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL) ) {
			...
			if(prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
	            ...
	            if(gsmCallHandlerId == null) {
	                gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, net.voxcorp.voxmobile.plugins.telephony.CallHandler.class)).flattenToString());
	            }
