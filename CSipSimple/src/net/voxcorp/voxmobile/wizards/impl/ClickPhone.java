...
public class ClickPhone extends SimpleImplementation {
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.voxmobile.wizards.impl.SimpleImplementation#fillLayout(net.voxcorp.voxmobile.api.SipProfile)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * net.voxcorp.voxmobile.wizards.impl.SimpleImplementation#buildAccount(com.csipsimple
     * .api.SipProfile)
     */
    @Override
