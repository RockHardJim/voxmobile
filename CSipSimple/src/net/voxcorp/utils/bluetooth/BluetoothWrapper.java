...
package net.voxcorp.utils.bluetooth;
	...
	public static BluetoothWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(14)) {
		        instance = new net.voxcorp.utils.bluetooth.BluetoothUtils14();
		    }else if(Compatibility.isCompatible(8)) {
                instance = new net.voxcorp.utils.bluetooth.BluetoothUtils8();
			}else {
                instance = new net.voxcorp.utils.bluetooth.BluetoothUtils3();
			}
		    if(instance != null) {
