...
package net.voxcorp.utils.contacts;
...
public class ContactsUtils5 extends ContactsWrapper {
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.utils.contacts.ContactsWrapper#isExternalPhoneNumber(android.content.Context, android.database.Cursor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.utils.contacts.ContactsWrapper#bindContactPhoneView(android.view.View, android.content.Context, android.database.Cursor)
     */
    @Override
