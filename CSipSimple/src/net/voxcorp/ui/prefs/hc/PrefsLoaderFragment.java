...
package net.voxcorp.ui.prefs.hc;
...
import net.voxcorp.ui.prefs.IPreferenceHelper;
import net.voxcorp.ui.prefs.PrefsLogic;
...
public class PrefsLoaderFragment extends PreferenceFragment implements IPreferenceHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        VoXMobileUtils.setVideoPreferenceListener(getActivity(), findPreference(SipConfigManager.USE_VIDEO));
    }
