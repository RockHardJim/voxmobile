...
import net.voxcorp.widgets.Dialpad;
import net.voxcorp.widgets.Dialpad.OnDialKeyListener;
import net.voxcorp.widgets.InCallControls2;
import net.voxcorp.widgets.InCallControls2.OnTriggerListener;
import net.voxcorp.widgets.InCallInfo2;
import net.voxcorp.widgets.ScreenLocker;


public class InCallActivity2 extends Activity implements OnTriggerListener, OnDialKeyListener, SensorEventListener, net.voxcorp.widgets.SlidingTab.OnTriggerListener {
...
//		Log.d(THIS_FILE, "Creating call handler for " + callInfo.getCallId()+" state "+callInfo.getRemoteContact());
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.ON_AFTER_RELEASE, "net.voxcorp.onIncomingCall");
	...
	protected void onStart() {
        ...
        if (keyguardManager == null) {
            ...
            keyguardLock = keyguardManager.newKeyguardLock("net.voxcorp.inCallKeyguard");
        }
			...
			if(winfo == null || 
				...
				try {
					...
					if( (supportedFlags & proximityScreenOffWakeLock) != 0x0 ) {
						...
						proximityWakeLock = powerManager.newWakeLock(proximityScreenOffWakeLock, "net.voxcorp.CallProximity");
