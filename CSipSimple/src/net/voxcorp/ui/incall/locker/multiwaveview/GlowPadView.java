...
package net.voxcorp.ui.incall.locker.multiwaveview;
...
import net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider;
import net.voxcorp.ui.incall.locker.IOnLeftRightChoice.TypeOfLock;
...
//        return Gravity.getAbsoluteGravity(mGravity, layoutDirection);
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.widgets.IOnLeftRightChoice.IOnLeftRightProvider#setOnLeftRightListener(net.voxcorp.widgets.IOnLeftRightChoice)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#applyTargetTitles(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#setTypeOfLock(net.voxcorp.ui.incall.locker.IOnLeftRightChoice.TypeOfLock)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#getLayoutingHeight()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#getLayoutingWidth()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.voxcorp.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#resetView()
     */
    @Override
